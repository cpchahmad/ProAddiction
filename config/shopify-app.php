...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_customers,write_customers,read_orders,write_orders, read_price_rules, write_price_rules, read_discounts, write_discounts'),
